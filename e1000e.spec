...
# Source0-md5:	94e86507f139226c1add173dafdbbd52
...
%description -n kernel%{_alt_kernel}-smp-net-%{pname} -l en.UTF-8
This package contains the Linux SMP driver for the Intel® PRO/1000
family of 10/100/1000 Ethernet network adapters. This driver is
